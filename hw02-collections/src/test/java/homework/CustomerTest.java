...
class CustomerTest {
    ...
    @Test
    @DisplayName("Customer unbroken check")
    ...
    @Test
    @DisplayName("Customer as card key")
    ...
    @DisplayName("Sorted on score, increase")
